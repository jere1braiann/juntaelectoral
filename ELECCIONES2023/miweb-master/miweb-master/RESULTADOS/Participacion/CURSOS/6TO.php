...
<html>
<head>
    <title>Gráfico de Participación - Sexto Año</title>
...
<body>
    <h1>Gráfico de Participación - Sexto Año</h1>
    ...
    // Consulta SQL para obtener los datos de participación en sexto año
    $sql = "SELECT dni, apellido_nombre, count, boleta_count FROM padron_electoral_general___hoja_1 WHERE curso = 'SEXTO AÑO'";
    ...
    echo "Del total de " . $totalEstudiantes . " estudiantes de sexto año, votaron " . $votaron . " (" . $porcentajeParticipacion . "%).";
    ?>
